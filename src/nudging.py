...
def nudge_generator_points(
    ...
    for label_point in label_points:
        ...
        vertex_point = Point(
            label_point.origin_point_x,
            label_point.origin_point_y,
        ...
        if closest_estimator.label != label_point.label:
            ...
            if pull:
                pull_vector = (
                    label_point_region_estimator_point.direction_to(
                        vertex_point, normalize=False
                    )
                    * phi
                )
            ...
            if push:
                push_vector = (
                    vertex_point.direction_to(closest_estimator, normalize=False) * phi
                )
